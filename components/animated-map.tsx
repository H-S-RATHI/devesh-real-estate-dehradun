        ...
        <section className="w-full bg-gradient-to-br from-slate-50 via-blue-50 to-blue-100 overflow-hidden relative">
                ...
                <div className="w-full">
                    <div className="relative group">
                        ...
                        <div className="relative bg-white/80 backdrop-blur-sm shadow-2xl border-t border-white/50">
                            <div className="relative overflow-hidden group-hover:shadow-3xl transition-all duration-500">
                                {/* Gradient overlay */}
                                ...
                                <iframe
                                    ...
                                    allowFullScreen
                                    loading="lazy"
                                    title="TOOTH-PICK, Dehradun Location"
                                    className="w-full h-64 sm:h-80 md:h-96 lg:h-[500px] border-0 transition-all duration-500 group-hover:scale-[1.02]"
                                />
                            </div>
