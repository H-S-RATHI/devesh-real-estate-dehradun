      ...
      <div className="container mx-auto px-4">
                ...
                <div className="relative">
                  ...
                  <div className="absolute inset-0 bg-black/0 hover:bg-black/10 transition-colors duration-300 flex items-center justify-center">
                    <div className="bg-white/90 px-4 py-2 rounded-lg opacity-0 hover:opacity-100 transition-opacity duration-300">
                      <span className="text-sm font-medium text-gray-900">Click to view details</span>
                    </div>
                  </div>
                </div>
              </Link>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-3">
                  <Link href={`/properties/${property.id}`}>
                    <div
                      className="bg-blue-600 hover:bg-blue-700 w-full text-center text-white px-4 py-2 rounded-md"
                    >
        ...
        {soldProject && (
          <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-8">
            ...
            <Card className="relative max-w-2xl mx-auto overflow-hidden cursor-pointer hover:shadow-xl transition-shadow duration-300">
              <Link href={`/properties/${soldProject.id}`} className="block">
                <Image
                ...
                <div className="absolute inset-0 bg-black/0 hover:bg-black/10 transition-colors duration-300 flex items-center justify-center">
                  <div className="bg-white/90 px-4 py-2 rounded-lg opacity-0 hover:opacity-100 transition-opacity duration-300">
                    <span className="text-sm font-medium text-gray-900">Click to view success story</span>
                  </div>
                </div>
              </Link>
              <Link href={`/properties/${soldProject.id}`} className="block hover:bg-gray-50 transition-colors duration-300">
                ...
                <CardContent className="px-6 pb-6 pt-2">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <h4 className="text-xl font-bold text-gray-900 hover:text-blue-600 transition-colors">{soldProject.title}</h4>
                    </div>
            ...
            <div className="text-center mt-8 space-y-4">
              <Link href={`/properties/${soldProject.id}`}>
                <div
                  className="bg-green-600 hover:bg-green-700 mr-4 text-white px-6 py-3 rounded-md text-lg"
                >
